        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <button onClick={() => scrollToSection('workflow')} className="text-gray-700 hover:text-emerald-600 transition-colors">
                Comment ça marche
              </button>
          ...
          {isMenuOpen && (
            <div className="md:hidden bg-white/95 backdrop-blur-md rounded-lg mt-2 p-4 shadow-lg">
              <div className="flex flex-col space-y-3">
                ...
                <button onClick={() => scrollToSection('workflow')} className="text-gray-700 hover:text-emerald-600 transition-colors text-left">
                  Comment ça marche
                </button>
      ...
      <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl md:text-2xl text-gray-600 mb-8 max-w-2xl mx-auto leading-relaxed">
            Prenez soin de vos vêtements et de la planète avec notre service de blanchisserie respectueux de l'environnement
          </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Nous sommes passionnés par l'entretien écologique de vos textiles, alliant efficacité et respect de l'environnement pour un service de qualité supérieure.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            <div className="text-center group">
              ...
              <p className="text-gray-600">
                Nous adaptons nos services à vos besoins spécifiques et à vos textiles.
              </p>
            </div>
            ...
            <div className="text-center group">
              ...
              <p className="text-gray-600">
                Nous garantissons un résultat impeccable avec des techniques de pointe respectueuses.
              </p>
            </div>
            ...
            <div className="text-center group">
              ...
              <p className="text-gray-600">
                Nous utilisons des produits biodégradables et des méthodes éco-responsables.
              </p>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-r from-emerald-50 to-lime-50 rounded-3xl p-8 md:p-12">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-lg text-gray-700 leading-relaxed">
                Chez Benevolent Sherbet, nous croyons qu'il est possible de prendre soin de vos vêtements tout en préservant notre planète. 
                Notre mission est d'offrir un service de blanchisserie de qualité supérieure en utilisant exclusivement des produits biodégradables, 
                des techniques économes en eau et en énergie, pour un avenir plus vert.
              </p>
            </div>
          </div>
        </div>
      ...
      <section id="workflow" className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Un processus simple et efficace en 4 étapes pour prendre soin de votre linge en toute sérénité.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center group">
              ...
              <div className="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300">
                <h3 className="text-xl font-bold mb-3 text-emerald-600">1. Réservation Facile</h3>
                <p className="text-gray-600">
                  Réservez votre service en ligne en quelques clics, choisissez vos options et planifiez la collecte.
                </p>
              </div>
            </div>
            ...
            <div className="text-center group">
              ...
              <div className="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300">
                <h3 className="text-xl font-bold mb-3 text-lime-600">2. Collecte à Domicile</h3>
                <p className="text-gray-600">
                  Notre équipe vient chercher votre linge directement chez vous, à la date et l'heure convenues.
                </p>
              </div>
            </div>
            ...
            <div className="text-center group">
              ...
              <div className="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300">
                <h3 className="text-xl font-bold mb-3 text-green-600">3. Lavage Écologique</h3>
                <p className="text-gray-600">
                  Votre linge est lavé avec soin, en utilisant des méthodes et des produits respectueux de l'environnement.
                </p>
              </div>
            </div>
            ...
            <div className="text-center group">
              ...
              <div className="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300">
                <h3 className="text-xl font-bold mb-3 text-emerald-600">4. Livraison Rapide</h3>
                <p className="text-gray-600">
                  Nous vous livrons votre linge propre et frais, directement à votre porte, prêt à être utilisé.
                </p>
              </div>
            </div>
          </div>
      ...
      <section id="services" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Découvrez nos services de blanchisserie respectueux de l'environnement, conçus pour prendre soin de vos vêtements et de la planète.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-gray-50 rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 group hover:-translate-y-2">
              ...
              <h3 className="text-xl font-bold mb-4 text-gray-800">Vêtements Courants</h3>
              <p className="text-gray-600 mb-4">Lavage et séchage doux pour vos articles du quotidien.</p>
              <p className="text-2xl font-bold text-emerald-600 mb-6">2 500 Ar / kg</p>
            ...
            <div className="bg-gray-50 rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 group hover:-translate-y-2">
              ...
              <h3 className="text-xl font-bold mb-4 text-gray-800">Vestes et Manteaux</h3>
              <p className="text-gray-600 mb-4">Nettoyage spécialisé pour vos vestes, manteaux et doudounes.</p>
              <p className="text-2xl font-bold text-lime-600 mb-6">15 000 Ar / pièce</p>
            ...
            <div className="bg-gray-50 rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 group hover:-translate-y-2">
              ...
              <h3 className="text-xl font-bold mb-4 text-gray-800">Textiles de Maison</h3>
              <p className="text-gray-600 mb-4">Entretien professionnel de vos draps, serviettes et rideaux.</p>
              <p className="text-2xl font-bold text-green-600 mb-6">5 000 Ar / pièce</p>
      ...
      <section id="contact" className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Planifiez facilement la collecte de votre linge en remplissant le formulaire ci-dessous. Nous nous occupons du reste !
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="bg-gradient-to-br from-emerald-50 to-lime-50 rounded-3xl p-8">
              <h3 className="text-2xl font-bold mb-6 text-gray-800">Formulaire de réservation</h3>
              ...
              <form className="space-y-6">
                ...
                <div>
                  ...
                  <select className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all duration-300">
                    ...
                    <option value="vetements-courants">Vêtements Courants (2 500 Ar/kg)</option>
                    <option value="vestes-manteaux">Vestes et Manteaux (15 000 Ar/pièce)</option>
                    <option value="textiles-maison">Textiles de Maison (5 000 Ar/pièce)</option>
                  </select>
                </div>
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">Instructions spéciales (optionnel)</label>
                  <textarea 
                    rows={4}
                    className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all duration-300 resize-none"
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-gray-600 mb-8">
                  Nous sommes là pour vous aider. N'hésitez pas à nous contacter pour toute question ou demande spéciale.
                </p>
              </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4 p-6 bg-white rounded-2xl hover:bg-gray-50 transition-colors duration-300 shadow-lg">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">contact@benevolent-sherbet.mg</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4 p-6 bg-white rounded-2xl hover:bg-gray-50 transition-colors duration-300 shadow-lg">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Lot II M 15 Bis Antananarivo<br />101 Antananarivo, Madagascar</p>
                  </div>
                </div>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-gray-400 mb-6">
              Blanchisserie écologique - Prenez soin de vos vêtements et de la planète depuis 2024
            </p>
            <div className="flex justify-center space-x-6 mb-8">
              ...
              <button onClick={() => scrollToSection('workflow')} className="text-gray-400 hover:text-emerald-400 transition-colors">
                Comment ça marche
              </button>
            ...
            <div className="pt-6 border-t border-gray-800">
              <p className="text-gray-500">
                © 2024 Benevolent Sherbet. Tous droits réservés. | Service de blanchisserie écologique à Madagascar
              </p>
            </div>
          </div>
        </div>
